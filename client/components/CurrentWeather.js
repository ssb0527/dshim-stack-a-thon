        ...
        <div className='weather'>
            <div className='top'>
                <div>
                    ...
                    <p className='weather-description'>{ data.weather[0].description.split(' ').map(word => word[0].toUpperCase()+word.substring(1)).join(' ') }</p>
                </div>
                <img alt='weather' className='weather-icon' src={ `images/weather icons/${ data.weather[0].icon }.png` } />
            </div>
